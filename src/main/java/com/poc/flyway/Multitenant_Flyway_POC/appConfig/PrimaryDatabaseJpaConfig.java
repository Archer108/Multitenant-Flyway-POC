...
/**
 * Configuration for the primary shared database (e.g. tenant registry, system-level tables).
 */
@Configuration
...
public class PrimaryDatabaseJpaConfig {
    ...
    public DataSource primaryDataSource() throws Exception {
        ...
        dataSource.setPassword(DecryptionUtil.decrypt(password));
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
        ...
        properties.put("hibernate.hbm2ddl.auto", "validate"); // Verify schema structure only
